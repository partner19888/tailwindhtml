...
**tailwindhtml-flips** takes an approach were, no code change is required instead, we generate utility classes using `[dir=rtl]` html attribute css selector.

### Demo

- https://tailwindhtml-flips.clodui.com
- https://tailwindhtml-flips.clodui.com/?lng=he (Hebrew version)

<img src="./img/demo.gif" />

## Installation

1. Install **tailwindhtml-flips** package:

```
# Install using NPM
npm install tailwindhtml-flips --save-dev

# Install using Yarn
yarn add tailwindhtml-flips --dev
```
